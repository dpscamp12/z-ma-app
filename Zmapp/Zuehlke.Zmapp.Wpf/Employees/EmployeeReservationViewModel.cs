...
{
	public class EmployeeReservationViewModel : NotificationObject
	{
		...
		public EmployeeReservationViewModel()
			: this(new CustomerServiceProxyRest(), new EmployeeReservationServiceProxyRest())
		{
		}
		...
		{
			this.service.ReserveEmployeeForCustomer(obj.Id, this.SelectedCustomer.Id, this.BeginOfWorkPeriod, this.EndOfWorkPeriod);
			this.RefreshValues();
		}
	}
}
